...
class DrogonConan(ConanFile):
    ...
    requires = ["openssl/1.1.1i", "trantor/1.5.0", "jsoncpp/1.9.4", "zlib/1.2.11", "brotli/1.0.9", "libpq/13.1", "mariadb-connector-c/3.1.11", "sqlite3/3.34.0", "hiredis/1.0.0"]
...
set(CMAKE_MODULE_PATH ${CMAKE_BINARY_DIR} ${CMAKE_MODULE_PATH})''')
        ...
        if self.settings.os != "Windows":
            ...
            tools.replace_in_file("drogon/CMakeLists.txt", "target_link_libraries(${PROJECT_NAME} PRIVATE Brotli_lib)", '''target_link_libraries(${PROJECT_NAME} PRIVATE ${CONAN_LIBS})''')
            ...
            tools.replace_in_file("drogon/CMakeLists.txt", "target_link_libraries(${PROJECT_NAME} PRIVATE SQLite3_lib)", '''target_link_libraries(${PROJECT_NAME} PRIVATE sqlite3  ${CONAN_LIBS})''')
            ...
            tools.replace_in_file("drogon/CMakeLists.txt", "target_link_libraries(${PROJECT_NAME} PRIVATE Brotli_lib)", '''target_link_libraries(${PROJECT_NAME} PRIVATE ${CONAN_LIBS} Rpcrt4)''')
            ...
            tools.replace_in_file("drogon/CMakeLists.txt", "target_link_libraries(${PROJECT_NAME} PRIVATE SQLite3_lib)", '''target_link_libraries(${PROJECT_NAME} PRIVATE sqlite3  ${CONAN_LIBS} Rpcrt4)''')
    ...
    def package(self):
        ...
        self.copy("*.h", dst="include/drogon", src="exports", keep_path=False)
