...
set(CMAKE_MODULE_PATH ${CMAKE_BINARY_DIR} ${CMAKE_MODULE_PATH})''')
    ...
    def package(self):
        ...
        self.copy("*drogon_ctl*", dst="bin", keep_path=False)
        self.copy("*dg_ctl*", dst="bin", keep_path=False)
        self.copy("webapp*", dst="bin", keep_path=False)
        self.copy("webapp_test*", dst="bin", keep_path=False)
        self.copy("client*", dst="bin", keep_path=False)
        self.copy("benchmark*", dst="bin", keep_path=False)
        self.copy("pipelining_test*", dst="bin", keep_path=False)
        self.copy("websocket_test*", dst="bin", keep_path=False)
        self.copy("multiple_ws_test*", dst="bin", keep_path=False)
