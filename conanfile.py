...
class DrogonConan(ConanFile):
    ...
    requires = ["trantor/1.2.0", "jsoncpp/1.9.4", "libuuid/1.0.3", "zlib/1.2.11", "openssl/1.1.1i", "c-ares/1.17.1", "brotli/1.0.9", "libpq/13.1", "mariadb-connector-c/3.1.11", "sqlite3/3.34.0"]
